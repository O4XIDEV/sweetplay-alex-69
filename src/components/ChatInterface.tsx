...
const ChatInterface: React.FC = () => {
  ...
  return (
    <div className="flex-1 overflow-y-auto px-3 py-4 pb-20 md:px-4">
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        {isTyping && (
          <div className="flex items-start mb-4">
            ...
            <div className="bg-card/50 px-4 py-3 rounded-2xl rounded-bl-sm text-muted-foreground max-w-[80%]">
